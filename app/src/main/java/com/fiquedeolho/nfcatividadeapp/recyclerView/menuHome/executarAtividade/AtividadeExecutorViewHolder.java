...
public class AtividadeExecutorViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
     ...
     * Construtor
     */
    public AtividadeExecutorViewHolder(View itemView) {
        super(itemView);
